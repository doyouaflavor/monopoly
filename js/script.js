    ...
    $(function(){
        ...
        $('input').click(function(){
            ...
            if(maxAns == 1){
                ...
                str = '明日的大富翁啊！<br>「去年給自己定了目標存款三萬，今天掐一下手指還差五萬」<br>現在還買不起房子，現在還沒有存款，<br>沒關係，人人都有機會，在夢裡變成大富翁！<div><img src="img/result2.jpg"/></div>';
            }else if(maxAns == 3){
                str = '心靈的大富翁啊！<br>只要是能用錢解決的事，一件都解決不了呢<div><img src="img/result3.jpg"/></div>';
                     }
            console.log(str);
            setFinalAnswer(str);
        });
